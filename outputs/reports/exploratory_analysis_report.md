...
社区 2: 包含 1907 个节点 (8.33% 的最大连通分量)
社区解释: 这是第2大的企业关系集群，内部企业间关系紧密。
节点类型分布:
  - 股东: 1464 个节点 (76.77%)
  - partner: 433 个节点 (22.71%)
  - 成员单位: 7 个节点 (0.37%)
  - 未知: 3 个节点 (0.16%)
社区内最重要的节点:
解释: 这些节点在该社区内连接最多，是社区的核心成员。
  - 物产中大（海南）发展有限公司 [成员单位]: 度 = 1847
  - 物产化工（浙江自贸区）有限公司 [成员单位]: 度 = 1532
  - 物产中大嘉悦（浙江）能源有限公司 [成员单位]: 度 = 1044
  - 物产中大乾睿能源化工（浙江）有限公司 [成员单位]: 度 = 959
  - 中基宁波集团股份有限公司 [partner]: 度 = 262

社区 3: 包含 1662 个节点 (7.26% 的最大连通分量)
